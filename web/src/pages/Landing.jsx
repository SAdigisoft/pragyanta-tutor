      ...
      <main className="landing-main">
        <section className="hero-copy">
          <div>
            ...
            <h1>Teach from sources you trust.</h1>
            <p>
              Pragyanta answers only from teacher-approved material, so every
              explanation stays grounded in your lesson.
            </p>
          </div>
        ...
        <section className="library-section" id="lessons">
          ...
          {loading ? (
            ...
            <div className="empty-card">
              ...
              <h3>Your lesson library is ready</h3>
              <p>
                Upload a PDF or paste lesson text to create your first
                evidence-based tutor.
              </p>
              <button
